    ...
    return (
        <ScrollView style={styles.screen} contentContainerStyle={styles.content}
            ...
            <View style={styles.actionsGrid}>
                {[
                    { icon: 'cube', label: 'Assets', color: colors.primary, onPress: () => { } },
                    { icon: 'layers', label: 'Inventory', color: colors.success, onPress: () => { } },
                    { icon: 'document-text', label: 'Procurement', color: colors.secondary, onPress: () => { } },
                    { icon: 'bar-chart', label: 'Analytics', color: colors.info, onPress: () => { } },
                ].map(a => (
