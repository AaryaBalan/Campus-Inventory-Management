...
export const buildings = [
    { id: 'B1', name: 'Admin Block', x: 60, y: 60, w: 120, h: 80, assetCount: 38, color: '#1e3a8a' },
    { id: 'B2', name: 'Library', x: 220, y: 60, w: 100, h: 80, assetCount: 24, color: '#0891b2' },
    { id: 'B3', name: 'Lecture Hall A', x: 360, y: 60, w: 130, h: 80, assetCount: 52, color: '#059669' },
    { id: 'B4', name: 'Science Lab', x: 60, y: 200, w: 120, h: 90, assetCount: 67, color: '#7c3aed' },
    { id: 'B5', name: 'Server Room', x: 220, y: 200, w: 100, h: 90, assetCount: 18, color: '#d97706' },
    { id: 'B6', name: 'Conference Room', x: 360, y: 200, w: 130, h: 90, assetCount: 15, color: '#0891b2' },
    { id: 'B7', name: 'Staff Room', x: 60, y: 350, w: 120, h: 80, assetCount: 21, color: '#dc2626' },
